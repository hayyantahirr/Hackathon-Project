  ...
  return (
    <>
      ...
      <div className="like-dislike-container container w-[40rem]">
        <p className="text-black flex"><img src={creatoPic} alt="" />{creator}</p>
        ...
        <div className="icons-box">
          <div className="icons">
            <label className="btn-label" htmlFor="like-checkbox">
              <span className="like-text-content text-black">123</span>
          ...
          <div className="icons">
            <label className="btn-label" htmlFor="like-checkbox">
              <span className="like-text-content text-black">123</span>
              <input className="input-box" id="like-checkbox" type="checkbox" />
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="svgs">
